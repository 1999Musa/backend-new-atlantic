            ...
            <a href="{{ route('admin.categories.index') }}"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0l2-2m-2 2l-2-2" />
                </svg>
                Go to Categories
            </a>
                ...
                @if($product->extraImages && $product->extraImages->isNotEmpty())
                    <div class="flex items-center gap-2 p-2">
                        @foreach($product->extraImages as $img)
                            <img src="{{ Storage::url($img->path) }}" alt="{{ $product->name }} extra"
