        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" step="0.01" name="price" class="mt-1 block w-full border rounded p-2" />
                </div>
                <div>
                    <label class="block text-sm font-medium">Discounted Price</label>
                    <input type="number" step="0.01" name="discounted_price" class="mt-1 block w-full border rounded p-2" />
                </div>
            </div>
            ...
            <div>
                ...
                <!-- Upload -->
                <input type="file" name="images[]" multiple class="mt-1" onchange="previewImages(event, 'mainPreview')" />
            </div>
            ...
            <!-- =========================== -->
            <div>
                <label class="block text-sm font-medium text-blue-700">Customize Page Images ( MAX 3 FOR BEST VIEW )</label>

                <!-- Preview -->
                <div id="customPreview" class="flex gap-2 mt-2 flex-wrap"></div>

                <!-- Upload -->
                <input type="file"  name="extra_images[]" multiple class="mt-1"
