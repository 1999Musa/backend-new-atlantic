...
@section('title', 'Edit Contact Hero Image')
...
<div class="container mx-auto">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-4">Edit Contact Hero Image</h2>
        ...
        <form action="{{ route('admin.contacthero.update', $hero->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <img src="{{ asset('storage/' . $hero->image) }}" alt="Current Hero Image" class="rounded-lg shadow-md max-w-xs">
            </div>

            <!-- Image Upload -->
            <div class="mb-6">
                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Upload New Image</label>
                <p class="text-xs text-gray-500 mb-2">Choosing a new file will replace the current image.</p>
