...
@section('title', 'Add Certified Logo')
...
<div class="container mx-auto">
    ...
    <!-- Add Certified Logo Form -->
    <div class="bg-white p-8 rounded-lg shadow-md max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold mb-6 text-gray-800 border-b pb-4">Add New Certified Logo</h2>
        ...
        <form method="POST" action="{{ route('admin.certified-logos.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="title" id="title" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 transition" placeholder="Enter logo title">
            </div>
